...
I am an **AI Engineer and Data Scientist** dedicated to designing and deploying production-ready intelligent systems. My focus lies at the intersection of state-of-the-art **Generative AI** (LLMs, RAG, AI Agents) and robust cloud platforms like **Databricks** and **Microsoft Azure AI**. 

I specialize in transforming unstructured text into actionable business value through advanced Natural Language Processing (NLP) pipelines and deep learning models.
